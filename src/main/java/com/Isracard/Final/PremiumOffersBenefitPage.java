...
public class PremiumOffersBenefitPage extends FooterHandler{

	/**
     * Constructor for the PremiumOffersBenefitPage
     * @param driver
     */
	public PremiumOffersBenefitPage(WebDriver driver) {
		super(driver);
	}
	...
	protected void openWindow(WebDriver driver) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("הטבות פרימיום")));
		driver.findElement(By.linkText("הטבות פרימיום")).click();
