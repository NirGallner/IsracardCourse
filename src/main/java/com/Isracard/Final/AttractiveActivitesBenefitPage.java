...
public class AttractiveActivitesBenefitPage extends FooterHandler{

	/**
     * Constructor for the AttractiveActivitesBenefitPage
     * @param driver
     */
	public AttractiveActivitesBenefitPage(WebDriver driver) {
		super(driver);
	}
	...
	protected void openWindow(WebDriver driver) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("אטרקציות")));
		driver.findElement(By.linkText("אטרקציות")).click();
	}
