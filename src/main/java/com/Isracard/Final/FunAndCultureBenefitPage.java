...
public class FunAndCultureBenefitPage extends FooterHandler{

	/**
     * Constructor for the FunAndCultureBenefitPage
     * @param driver
     */
	public FunAndCultureBenefitPage(WebDriver driver) {
		super(driver);	
	}
	...
	protected void openWindow(WebDriver driver) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("תרבות ופנאי")));
		driver.findElement(By.linkText("תרבות ופנאי")).click();	
	}
	...
	public void useWindow(WebDriver driver) {
		try {
			Assertions.assertEquals("תרבות ופנאי", driver.getTitle() ,"The title should be תרבות ופנאי");
			}
