...
public class SurprisesBenefitPage extends FooterHandler{

	/**
     * Constructor for the SurprisesBenefitPage
     * @param driver
     */
	public SurprisesBenefitPage(WebDriver driver) {
		super(driver);
	}
	...
	protected void openWindow(WebDriver driver) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.partialLinkText("הפתעות")));
		driver.findElement(By.partialLinkText("הפתעות")).click();	
	}
