...
public class ParentsAndKidsBenefitPage extends FooterHandler {

	/**
     * Constructor for the ParentsAndKidsBenefitPage
     * @param driver
     */
	public ParentsAndKidsBenefitPage(WebDriver driver) {
		super(driver);
	...
	protected void openWindow(WebDriver driver) {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(By.linkText("הורים וילדים")));
		driver.findElement(By.linkText("הורים וילדים")).click();	
	}
